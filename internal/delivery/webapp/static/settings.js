...
const BOT_HD_FIELDS = [
  ...
  ['spam_screen', 'bool', 'Проверка новых пользователей на спам', 'Сообщения новичков со ссылками, @упоминаниями, пересылками или на китайском/арабском и т. п. ждут решения оператора в теме «Карантин»'],
  ['spam_captcha', 'bool', 'Капча для новых пользователей', 'Новичок должен нажать «Я не бот», прежде чем его сообщение дойдёт до операторов'],
];
